...
def nomes_moedas():
    with open("C:/Users/arian/OneDrive/Área de Trabalho/Programacao/projetos/projetosBasicosPython/conversorDeMoedas/moedas.xml", "rb") as arquivo_moedas:
...
def conversoes_disponiveis():
    with open("C:/Users/arian/OneDrive/Área de Trabalho/Programacao/projetos/projetosBasicosPython/conversorDeMoedas/conversoes.xml", "rb") as arquivo_conversoes:
